...
{        
    ...
    int numnodesininterface = els->istypeinelementlist(0, &interfaceelems, isnodeininterface, false);
    int numedgesininterface = els->istypeinelementlist(1, &interfaceelems, isedgeininterface, false);
    ...
    for (int r = 0; r < numranks; r++)
    {
        ...
        {
            els->istypeinelementlist(0, physregsvec[3*r+(meshdim-1)]->getelementlist(), isnodeinneighbours[r], false);
            els->istypeinelementlist(1, physregsvec[3*r+(meshdim-1)]->getelementlist(), isedgeinneighbours[r], false);
        }
    }
